...
////État: En cours, non complet, ajouter fct "modifier string" ou même ajouter string?
//using System;
...
//        {
//            MessagesEnString = new List<string>(message);
...
//        }
//        void CréerListeTiles()//prendre les rectangles sources de la police
//        {
//            //à simplifier pour que ça marche avec toutes les textures (à ajouter ensuite dans AfficheurTexte et Cadre, on devrait pas faire une classe Tile qui aurait tout ce qui faut pour prendre une texture et faire une liste de rectangle sources ?)
//            for (int i = 0; i < (TexturePolice.Width / TAILLE_TILE) - 1; i++)//Ligne A
//            {
//                RectangleSourcesPolice.Add(new Rectangle(TAILLE_TILE * i, 0, TAILLE_TILE, TAILLE_TILE)); // A = 0; i = 0; j = 0
//            }
//            for (int i = 0; i < (TexturePolice.Width / TAILLE_TILE) - 1; i++)//Ligne B
//            {
//                RectangleSourcesPolice.Add(new Rectangle(TAILLE_TILE * i, TAILLE_TILE, TAILLE_TILE, TAILLE_TILE)); // A = 0; i = 0; j = 0
//            }
//        }
