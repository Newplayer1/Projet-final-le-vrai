...
namespace AtelierXNA
{
    ...
    public class Jeu : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            Game.Components.Insert(Game.Components.Count - 1, new Trainer(Game, "AZ", …CHELLE_OBJET, rotationObjet, positionCPU,INTERVALLE_MAJ_STANDARD, 1f));
            Game.Components.Insert(Game.Components.Count - 1, new Trainer(Game, "AZ", …CHELLE_OBJET, rotationObjet, positionObjet, INTERVALLE_MAJ_STANDARD, 1f));
        }
