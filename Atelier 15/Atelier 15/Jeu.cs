...
namespace AtelierXNA
{
    ...
    public class Jeu : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            Game.Components.Insert(Game.Components.Count - 1, new Trainer(Game, "Trainer/AZ", …CHELLE_OBJET, rotationObjet, positionCPU, INTERVALLE_MAJ_STANDARD, 1f));
            Game.Components.Insert(Game.Components.Count - 1, new ObjetDeBase(Game, "4Charmander/Charmander", …CHELLE_OBJET * 2, rotationObjet, positionCPU));
