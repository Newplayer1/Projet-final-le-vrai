...
namespace AtelierXNA
{
   public class AfficheurFPS : Microsoft.Xna.Framework.DrawableGameComponent
   {
      ...
      public override void Draw(GameTime gameTime)
      {
         ...
         GestionSprites.DrawString(policeDeCaractères, ChaîneFPS, PositionChaîne, CouleurFPS, AUCUNE_ROTATION, Vector2.Zero, AUCUNE_HOMOTHÉTIE, SpriteEffects.None, AVANT_PLAN);
         GestionSprites.End();
      }
   }
}